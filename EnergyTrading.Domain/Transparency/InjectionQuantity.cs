...
public sealed class InjectionQuantity : BaseEntity, IPeriodEntity
{
    public DateOnly Date { get; set; }
    public int TimeOfPeriodId { get; set; }
    public decimal Asphaltite { get; set; }
    ...
    public decimal InternationalExport { get; set; }
    public decimal InternationalImport { get; set; }
